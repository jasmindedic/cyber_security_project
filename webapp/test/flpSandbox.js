		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cybersecuritycybersecurity-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cybersecuritycybersecurity-display": {
								"semanticObject": "cybersecuritycybersecurity",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cybersecurity.cybersecurity",
									"url": sap.ui.require.toUrl("cybersecurity/cybersecurity")
								}
							}
						}
					}
